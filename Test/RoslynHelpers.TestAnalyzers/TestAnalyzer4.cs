...
";
        ...
        bool HasGlobalSystem = UsingDirectiveHelper.HasGlobalSystem(SortedUsings) || UsingDirectiveHelper.HasGlobalSystem(string.Empty);

        if (HasGlobalSystem && SortedUsings == SortedUsings2)
            return;
