...
if exist .\Test\%TESTPROJECTNAME%\obj\Debug\%RESULTFILENAME% .\packages\%CODECOV%\tools\codecov -f ".\Test\%TESTPROJECTNAME%\obj\Debug\%RESULTFILENAME%" -t %ROSLYN_HELPERS_CODECOV_TOKEN%
